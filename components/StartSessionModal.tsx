...
export default function StartSessionModal({ isOpen, onClose, onSessionStarted }: Props) {
  ...
  // Auto-update start stack when stake changes
  useEffect(() => {
    ...
    <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-sm p-6 shadow-xl border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="flex gap-3 mt-6">
          <button 
            onClick={onClose}
            className="flex-1 py-2.5 rounded-lg font-semibold text-zinc-600 bg-zinc-100 dark:bg-zinc-800 dark:text-zinc-300"
          >
            Cancel
          </button>
          <button 
            ...
            className="flex-1 py-2.5 rounded-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50"
          >
